...
<html lang="en">
    ...
    <head>
        ...
        <meta name="version" content="v0.10.16">
        ...
        <link rel="icon" type="image/svg+xml"
                href="https://cdn.jsdelivr.net/npm/@metreeca/mark@v0.10.16/dist/index.svg"/>

        <link rel="stylesheet" type="text/css"
                href="https://cdn.jsdelivr.net/npm/@metreeca/mark@v0.10.16/dist/index.css">

        <script type="module"
                src="https://cdn.jsdelivr.net/npm/@metreeca/mark@v0.10.16/dist/index.js"></script>
